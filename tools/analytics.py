...
class AnalyticsTools:
    ...
    async def search_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_branch_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/branch-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_stock_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/stock-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_product_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/product-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_person_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/person-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_seller_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/seller-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_payment_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/payment-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_representative_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/representative-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_buyer_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/buyer-fiscal-movement/search", _fiscal_movement_body(args))
    ...
    async def search_operation_fiscal_movement(self, args: dict[str, Any]) -> Any:
        ...
        return await self.client.post(f"{BASE_ANALYTICS}/operation-fiscal-movement/search", _fiscal_movement_body(args))
